...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('review')
        .setDescription('Review code quality and suggest improvements.')
        ...
        .addAttachmentOption(option =>
            option.setName('file1')
                .setDescription('A file containing the code to review.'))
        .addAttachmentOption(option =>
    ...
    async execute(interaction) {
        ...
        if (!code && attachments.length === 0) {
            return interaction.editReply('Please provide either code as text or at least one file to review.');
        }

        let prompt = "Review the following code for quality and suggest improvements:";
        if (language) {
            prompt = `Review the following ${language} code for quality and suggest improvements:`;
        }
